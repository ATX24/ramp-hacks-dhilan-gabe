...
function candidateLabel(armId: string): string {
  const labels: Record<string, string> = {
    ...
    sequence_kd: "Taught smaller model",
    logit_kd: "Score-taught model",
      ...
      <section aria-labelledby="prove-heading">
        <div className="panel">
          ...
          <p data-testid="prove-empty">
            There is no result to check yet. Start with the saved finance example to
    ...
    <section aria-labelledby="prove-heading">
      <div className="panel">
        ...
        <p>
          ...
          It also needs to run fast enough and cost less.
        </p>
        <ErrorBanner error={error} />
        <div
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Confidence comes from a saved run. No live model is running now.
            </p>
          </div>
      ...
      <div className="panel">
        ...
        <p>
          Each candidate uses a different way to make the smaller model. The range
          shows how much the saved score may vary.
        </p>
        <div className="table-wrap">
          <table className="data">
            ...
            <tbody>
              {proof.arms.map((arm) => (
                <tr key={arm.arm_id}>
                  <td>{candidateLabel(arm.arm_id)}</td>
                  <td>{arm.purpose}</td>
      ...
      <div className="grid-2">
        <details className="panel">
          ...
          <p>
            These numbers record response time, capacity, memory use, and machine time.
          </p>
          {proof.systems ? (
            <div className="table-wrap">
              <table className="data">
