...
This teacher-sparing behavior is part of the method resolver rather than a marketing promise. Counts of imported, oracle, teacher-generated, and rejected labels are carried into the run manifest and evaluation package.
...
The released system completed the four-stage workflow for TinyFable. It created a frozen synthetic finance dataset, disclosed its recipe resolution, executed the sealed training manifest through the finite job backend, reloaded the resulting portable artifact, and produced an immutable evaluation report. TinyFable was approved for release; the same interfaces also exercised non-success statuses through frozen evaluation fixtures.
...
Prove & Immutable evaluation report & Approved \\
\bottomrule
\end{tabular}
